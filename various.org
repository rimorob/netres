...
## with blacklist
blist = rbind(data.frame(from = colnames(generated$data), to = "vlat1"),
              data.frame(from = colnames(generated$data), to = "vlat2")
              )
...
netResObj_nolat = NetRes$new(generated$data %>%
                       ...
                       true.graph = generated$graph, nIter = 3, nBoot=100, algorithm='tabu', algorithm.args = tabuArgs2, mode=NULL)
