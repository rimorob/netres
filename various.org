...
library(igraph)
library(bnlearn)
source("/Users/fred/Documents/projects/gnsutils/gnsutils/R/networks.R")
devtools::load_all("./NetRes")

insurancenet=readRDS("/Users/fred/Documents/gitRepos/general-functions/org/bnlearn/insurance.rds")

insurance_ig=as.igraph(insurancenet)


insurance_ig=addConfounderIgraph(insurance_ig,prob=0.8,ucoef=2)
...
data_insurance=sim(insurance_simc_set,n=400)
...
netResObj = NetRes$new(generated$data, true.graph = generated$graph, nIter = 20, nBoot=100, algorithm='tabu', algorithm.args = algArgs, mode='normal', weightedResiduals=FALSE, scale=TRUE, latentSpaceMethod='sparsepca') 
#+end_src
