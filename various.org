...
netResObj$assess(nCores=4,lvPrefix="U",iteration=2)
...
netResObj_oracle$assess(iteration=1,lvPrefix="U")

netResObj$assess(nCores=4,lvPrefix="U",iteration=2,oracle=netResObj_oracle) 
#+end_src
