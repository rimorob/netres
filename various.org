...
bnlearn::graphviz.plot(generated$graph, layout='dot', highlight = list(nodes = grep('U_', colnames(generated$data), value=T), col = "tomato", fill = "orange"),nodesep=0.001)

plotIgraph(as.igraph(generated$graph),nodesep=0.001,fill=list("U_.*"="orange"))
...
colnames(generated$data) %>% grep(pattern="U_.*",value=T)
...
netResObj_nolat = NetRes$new(generated$data %>%
                       mutate(vlat1=U_v17,
                              vlat2=U_v80
                              ),
