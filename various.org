...
network = SFNetwork$new(numVertices=100, numChildren = 2, par1=1, nParentOnly = 3, supersize.top.hubs = F, supersize.factor=1)

networkig=network$dag %>% as.igraph()
...
ppPlotIgraph(networkig,nodesep=0.01,check_size = F)
...
data_network=sim(networkd_simc_set,n=1000)
