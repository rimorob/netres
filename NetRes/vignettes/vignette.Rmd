...
##demo script
network = SFNetwork$new(numVertices=20, topology='star', addOneEdge = TRUE)
library(brms)
generated = network$generateData(numSamples = 100, latIdx = 1, rescaleNoiseBy=function(mu=0.5, sigma=0.5, alpha=-5) {
    return(rskew_normal(1, mu, sigma, alpha))
})
library(GGally)
ggpairs(generated$data)
