...
network = SFNetwork$new(numVertices=1000, numChildren = 2, par1=1.2, nHubs = 2, hubInfluence = 500)
network$plotVennDiagramOfChildren(network$vRank[c(1:2)])

generated = network$generateData(numSamples=200, latIdx = c(1, 2))#, rescaleNoiseBy = NULL)
