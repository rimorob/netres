...
network = SFNetwork$new(numVertices=50, numChildren = 3, par1=1, nParentOnly = 3, supersize.top.hubs = TRUE, supersize.factor=10)

generated = network$generateData(numSamples=500, latIdx = c(2, 3))#, rescaleNoiseBy=NULL)
...
Example 5 - a real example of gene expression and protein levels of neurons in the striatum of mice with Huntington's disease
