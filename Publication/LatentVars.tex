...
\begin{figure}[ht]
  ...
  \begin{minipage}[t]{0.42\linewidth}
    ...
    \caption{\label{fig:latrecons}$R^2$ in the prediction of the latent variable from the selected principal components.}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.42\linewidth}
    \includegraphics[scale=0.2]{images/fig_paper_errors.pdf}
