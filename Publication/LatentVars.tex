...
%NEW TITLE
\title{DeepCausal: An Algorithm For Calculating Average Causal Effects Of Interventions In The Presence Of Pleiotropic Latent Variables Using Belief Networks and Deep Learning}
...
\author{%
  ...
  GNS Healthcare\\
  Cambridge, MA 02142 \\
  \texttt{fred@gnshealthcare.com} \And
  Anna Decker\\
  Precision Medicine\\
  GNS Healthcare\\
  Cambridge, MA 02142 \\
  \texttt{adecker@gnshealthcare.com} \And
  Raymond Yan
  Precision Medicine\\
  GNS Healthcare\\
  Cambridge, MA 02142 \\
  \texttt{ryan@gnshealthcare.com}
